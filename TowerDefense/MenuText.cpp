...
MenuText::MenuText(std::string _name, int _x, int _y, int& _fonte, double _r , double _g , double _b)
	:Menu(_name, _x, _y, _fonte, _r, _g, _b)
{
}

MenuText::MenuText(std::string _name, int _x, int _y, int& _fonte, char* _cor)
	:Menu(_name, _x, _y, _fonte, _cor)
{
}
